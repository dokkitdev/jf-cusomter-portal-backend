...
class ParsingLogTest extends TestCase
{
    ...
    public function testSearchAuthorization(?int $userId, int $statusCode, ?string $responseFixture): void
    {
        ...
        $response = $this->json('get', '/notify/parsing-logs');
    ...
    {
        $response = $this->actingAsById(101)->json('get', '/notify/parsing-logs', $filters);
